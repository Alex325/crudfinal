...
<div class="reg-container">
    <div class="reg-titulo">
        <span class="reg-titulo-texto">{{ $reg->titulo }}</span>
    </div>
    <div class="reg-altdel">
        <a href="{{route('registro.edit', $reg->id)}}" id="reg-alt">
        ...
        <a href="{{route('registro.delete', $reg->id)}}" id="reg-del">
    ...
    <div class="reg-frase">
        <span class="reg-frase-texto">{{ $reg->frase_do_dia }}</span>
    </div>
    <br>
    <div class="reg-adicionado">
        <span class="reg-adicionado-texto">Adicionado {{ $dataFormatada }}</span>
    </div>
    <br>
    <br>
    <div class="reg-texto">
        <span class="reg-texto-texto">{{ $reg->texto }}</span>
    </div>
</div>
</div>
</div>
