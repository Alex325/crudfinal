...
<div class="add-foto-form-container">
    <form action="{{route('fotografia.update', $foto->id)}}" method="post" class="add-foto-form" enctype="multipart/form-data">
        @csrf
        @METHOD("PATCH")
        <div class="input-container input-container-titulo">
            <label class="label titulo" for="titulo-input">Título</label>
            <input type="text" value="{{$foto->titulo }}" name="titulo" id="titulo-input" class="input" required>
        </div>
        <div class="input-container input-container-legenda">
            <label class="label legenda" for="legenda-input">Legenda</label>
            <input type="text" value="{{$foto->legenda}}" name="legenda" id="legenda-input" class="input"  required>
        </div>
        <div class="input-container input-container-data">
            <label class="label data" for="data-input">Data da Foto</label>
            <input type="date" value="{{$foto->data_da_foto}}" name="data" id="data-input" class="input">
        </div>
